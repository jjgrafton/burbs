...
class LocationsController < ApplicationController
    ...
    def show
        ...
        train = HTTParty.get("https://maps.googleapis.com/maps/api/directions/JSON?#{@place_id}&destination=place_id:ChIJhRwB-yFawokRi0AhGH87UTc&transit_mode=rail&key=AIzaSyD6LM1YiZNO8S1FixZXf9hKfAP2KS-V2w4")
        pp train 
